<div class="header__cart">                    
    @auth
        ...
        @else
                   ...
                   <li class="header__cart-item">
                    ...
                    <div class="header__cart-item-info">
                        <div class="header__cart-item-head">
                            <a href="{{ route('book.details',['name' => $item->book_name, 'id' => $item->id]) }}" class="header__cart-item-link-name">
            ...
            <a href="{{ route('cart.page',Auth::user()->account_name) }}" class="btn btn--primary header__cart-view-cart">Xem giỏ hàng</a>
            </div>
        @endif
    @endauth
    @guest
